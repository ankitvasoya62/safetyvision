        ...
        <div class="panel-body">
            <?php if ($step == 0) { ?>
                ...
                <div class="row">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="input-group" style="margin-bottom:10px;">
                                    ...
                                    <input class="form-control" type="text" required="required" name="name" id="spot-title" style="width:580px;"/>
                                </div>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div style="margin-top: 5px;"><button class="btn btn-primary"  id="submit-button" disabled>Next</button></div>
                </div>
            <?php } else if ($step == 1) { ?>
                        ...
                        <tr>
                            <td colspan="2">
                                <div id="video-pane">
                                    ...
                                    <div id="loaded-video">
                                        <video src="" autoplay width="100%" type="video/mp4" controls="">
                                            <source src="ho.mp4" type="video/mp4">
                                            <source src="ho.ogg" type="video/x-ms-asf">
                                        </video>
                                    </div>
                                </div>
                            </td>
